...
-- Password:   `password`
--
DROP DATABASE IF EXISTS StaySimple;
CREATE DATABASE IF NOT EXISTS StaySimple;
USE StaySimple;
...
CREATE TABLE `payment` (
  ...
  PRIMARY KEY (`id`),
  CONSTRAINT `fk_payment_roombook` FOREIGN KEY (`id`) REFERENCES `roombook`(`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE `roombook` (
  ...
  PRIMARY KEY (`id`),
  CONSTRAINT `fk_roombook_room` FOREIGN KEY (`RoomType`, `Bed`) REFERENCES `room`(`type`, `bedding`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
(1, 'Rahul Sharma', 'rahul.sharma@example.com', 'password1'),
(2, 'Pooja Verma', 'pooja.verma@example.com', 'password2'),
(3, 'Amit Patel', 'amit.patel@example.com', 'password3'),
(4, 'Sneha Kapoor', 'sneha.kapoor@example.com', 'password4'),
(5, 'Rohit Mehta', 'rohit.mehta@example.com', 'password5');
...
(1, 'Vijay Kumar', 'Manager'),
(2, 'Anita Singh', 'Assistant Manager'),
(3, 'Ramesh Gupta', 'Cook'),
(4, 'Suresh Joshi', 'Helper'),
(5, 'Lakshmi Nair', 'Cleaner'),
(6, 'Mohit Agarwal', 'Waiter'),
(7, 'Priya Desai', 'Waiter'),
(8, 'Arjun Rao', 'Cook'),
(9, 'Ravi Sharma', 'Helper'),
(10, 'Meera Reddy', 'Cleaner');
